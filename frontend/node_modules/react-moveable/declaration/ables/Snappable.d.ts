import { Renderer, SnappableProps, SnappableState, SnapGuideline, ScalableProps, RotatableProps, RectInfo, DraggableProps, MoveableManagerInterface, BoundType, SnapBoundInfo, MoveableGroupInterface } from "../types";
...
export declare function checkSnapBounds(guideines: SnapGuideline[], bounds: BoundType | undefined | false, posesX: number[], posesY: number[], options?: {
    isRequest?: boolean;
