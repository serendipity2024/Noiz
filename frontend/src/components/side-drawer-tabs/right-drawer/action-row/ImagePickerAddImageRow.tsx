...
import { ImagePickerAddImageHandleBinding } from '../../../../shared/type-definition/EventBinding';
import { NullableReactElement } from '../../../../shared/type-definition/ZTypes';
import { ZThemedColors } from '../../../../utils/ZConst';
import ZConfigRowTitle from '../shared/ZConfigRowTitle';
import i18n from './ImagePickerAddImageRow.i18n.json';
import { Select } from '../../../../zui';

interface Props {
  componentModel: BaseComponentModel;
  event: ImagePickerAddImageHandleBinding;
  onEventChange: () => void;
}
export default observer(function ImagePickerAddImageRow(props: Props): NullableReactElement {
