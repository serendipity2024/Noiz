...
import { ImagePickerDeleteImageHandleBinding } from '../../../../shared/type-definition/EventBinding';
...
interface Props {
  ...
  event: ImagePickerDeleteImageHandleBinding;
  onEventChange: () => void;
}
export default observer(function ImagePickerDeleteImageRow(props: Props): NullableReactElement {
