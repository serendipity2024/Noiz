...
var defaultI18nProvider = ra_i18n_polyglot_1.default(function (locale) { return (messages[locale] ? messages[locale] : messages.en); }, react_admin_1.resolveBrowserLocale());
exports.translateWrapper = function () {
    var translateSystem = react_admin_1.useTranslate();
