...
const ListActions = (props: any) => {
  ...
  const dynamicTyping = (columnName: string) => {
    if (_.includes(["query_string"], columnName))
      return false;
    return true;
  }
  ...
  const customExporter = (posts: any[]) => {
    ...
    jsonExport(filteredPosts, (err, csv) => {
      const BOM = '\uFEFF';
      downloadCSV(`${BOM}${csv}`, 'fz_audit_record');
    });
  }
  ...
  return (
    ...
    {filters && cloneElement(filters, {
      ...
      const Fz_audit_recordFilter = (props: any) => (
        <Filter {...props}>
        ...
        <NumberInput source="account_id_≤">

</NumberInput>
        <NumberInput source="account_id_≥">

</NumberInput>
<TextInput source="query_string">
      ...
      export const Fz_audit_recordList = (props:any) => (
        <List empty={false} {...props} hasEdit={false} hasList={true} 
          ...
          bulkActionButtons={< ListBulkActions />} filters={<Fz_audit_recordFilter />}
        >
          <Datagrid expand={<Fz_audit_recordShow />} >
...
<TextField source="query_string">

</TextField>
<FunctionField render={(record: any) => record.variables ?
              <pre>{JSON.stringify(record.variables, null, 2)}</pre> : <></>} source="variables">
...
<DateField showTime={true} source="created_at">
      ...
      export const Fz_audit_recordEdit = (props:any) => (
...
<RichTextInput component="pre" multiline="true" source="query_string">

</RichTextInput>
<TextInput multiline="true" source="variables">
...
<DateTimeInput source="created_at">
      ...
      export const Fz_audit_recordCreate = (props:any) => (
        <Create {...props}>
          <SimpleForm>
            <NumberInput source="id" disabled={true}>
...
<DateTimeInput source="created_at">
      ...
      export const Fz_audit_recordShow = (props:any) => (
        <Show {...props}>
          <SimpleShowLayout>
