...
const ListActions = (props: any) => {
  ...
  const customExporter = (posts: any[]) => {
    ...
    jsonExport(filteredPosts, (err, csv) => {
      const BOM = '\uFEFF';
      downloadCSV(`${BOM}${csv}`, 'image_storage');
    });
  }
  ...
  return (
    ...
    validateRow={validateRow} />
      ...
      const Image_storageFilter = (props: any) => (
        <Filter {...props}>
        ...
        <NumberInput source="bannerr_banner_≤">
      ...
      export const Image_storageList = (props:any) => (
        <List empty={false} {...props} hasEdit={true} hasList={true} 
          ...
          bulkActionButtons={< ListBulkActions />} filters={<Image_storageFilter />}
        >
          <Datagrid expand={<Image_storageShow />} >
...
<ReferenceField label="bannerr" source="bannerr_banner" reference="banner" link="show">
<ChipField source="id">
      ...
      export const Image_storageEdit = (props:any) => (
...
<ReferenceInput label="bannerr" source="bannerr_banner" reference="banner" allowEmpty={true}>
<AutocompleteInput optionText="id" matchSuggestion={() => true}>

</AutocompleteInput>
</ReferenceInput>
      <ReferenceArrayInput label="banner" source="banner" reference="banner">
<SelectArrayInput allowEmpty={true} optionText="id">
      ...
      export const Image_storageCreate = (props:any) => (
        <Create {...props}>
          <SimpleForm>
            <NumberInput source="id" disabled={true}>
...
<AutocompleteInput optionText="id" matchSuggestion={() => true}>
      ...
      export const Image_storageShow = (props:any) => (
        <Show {...props}>
          <SimpleShowLayout>
...
<ChipField source="id">
      ...
      <ReferenceManyField label="banner" target="images_image_storage" reference="banner">
