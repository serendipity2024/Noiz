...
const ListActions = (props: any) => {
  ...
  const dynamicTyping = (columnName: string) => {
    if (_.includes(["key","value"], columnName))
      return false;
    return true;
  }
...
<TextInput source="value">
      ...
      export const CustomList = (props:any) => (
        <List empty={false} {...props} hasEdit={true} hasList={true} 
          ...
          bulkActionButtons={< ListBulkActions />} filters={<CustomFilter />}
        >
          <Datagrid expand={<CustomShow />} >
...
<RichTextInput component="pre" multiline="true" source="key">

</RichTextInput>
<RichTextInput component="pre" multiline="true" source="value">
      ...
      export const CustomCreate = (props:any) => (
        <Create {...props}>
          <SimpleForm>
            <NumberInput source="id" disabled={true}>
...
<RichTextInput component="pre" multiline="true" source="value">
      ...
      export const CustomShow = (props:any) => (
        <Show {...props}>
          <SimpleShowLayout>
