...
const ListActions = (props: any) => {
  ...
  const preCommitCallback = async (action: 'create' | 'overwrite', values: any[]) => {
    const rows = await Promise.all(values.map(async value => {
      ...
      if (value['product_image_id'] && isString(value['product_image_id']) && !isId(value['product_image_id'])) {
        const media = await processMedia(value['product_image_id'], MediaType.IMAGE) as {id: string, downloadUrl: string};
        value['product_image_id'] = media.id;
      }
  ...
  const validateRow = async (value: any) => {
      ...
      if (value['product_image_id'] && isString(value['product_image_id']) && !isId(value['product_image_id'])) {
        const result = await validateMedia(value['product_image_id']);
  ...
  const dynamicTyping = (columnName: string) => {
    if (_.includes(["status","title","content"], columnName))
      return false;
    return true;
  }
...
<TextInput source="status">
        ...
        <DateInput source="product_date_≤">
...
<TextInput source="content">
      ...
      export const ProductList = (props:any) => (
        <List empty={false} {...props} hasEdit={true} hasList={true} 
          ...
          bulkActionButtons={< ListBulkActions />} filters={<ProductFilter />}
        >
          <Datagrid expand={<ProductShow />} >
...
<ImageField source="product_image.url">

</ImageField>
<DateField source="product_date">

</DateField>
<TextField source="title">

</TextField>
<ReferenceField label="tags" source="tags_tag" reference="tag" link="show">
<ChipField source="id">
...
<ImageInput accept="image/*" source="product_image">
<ImageField source="url">

</ImageField>
</ImageInput>
<DateInput source="product_date">

</DateInput>
<RichTextInput component="pre" multiline="true" source="title">

</RichTextInput>
<ReferenceInput label="tags" source="tags_tag" reference="tag" allowEmpty={true}>
...
<RichTextInput component="pre" multiline="true" source="content">

</RichTextInput>
      <ReferenceArrayInput label="tagss" source="tagss" reference="tag">
...
<TextField source="content">
      ...
      <ReferenceManyField label="tagss" target="productt_product" reference="tag">
