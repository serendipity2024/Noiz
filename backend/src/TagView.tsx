...
const ListActions = (props: any) => {
  ...
  const dynamicTyping = (columnName: string) => {
    if (_.includes(["name","description","status"], columnName))
      return false;
    return true;
  }
...
<TextInput source="name">
        ...
        <NumberInput source="productt_product_≤">
...
<TextInput source="description">
        ...
        <NumberInput source="business_business_≤">
...
<TextInput source="status">
      ...
      export const TagList = (props:any) => (
        <List empty={false} {...props} hasEdit={true} hasList={true} 
          ...
          bulkActionButtons={< ListBulkActions />} filters={<TagFilter />}
        >
          <Datagrid expand={<TagShow />} >
...
<ReferenceField label="productt" source="productt_product" reference="product" link="show">
<ChipField source="id">
...
<ReferenceField label="business" source="business_business" reference="business" link="show">
<ChipField source="id">
...
<ReferenceInput label="productt" source="productt_product" reference="product" allowEmpty={true}>
<AutocompleteInput optionText="id" matchSuggestion={() => true}>

</AutocompleteInput>
</ReferenceInput>
<RichTextInput component="pre" multiline="true" source="description">

</RichTextInput>
<ReferenceInput label="business" source="business_business" reference="business" allowEmpty={true}>
<AutocompleteInput optionText="id" matchSuggestion={() => true}>
...
<TextField source="status">
      ...
      <ReferenceManyField label="product" target="tags_tag" reference="product">
