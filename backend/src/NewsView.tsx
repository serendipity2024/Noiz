...
const ListActions = (props: any) => {
  ...
  const dynamicTyping = (columnName: string) => {
    if (_.includes(["status","title","subtitle","content"], columnName))
      return false;
    return true;
  }
...
<TextInput source="content">
      ...
      export const NewsList = (props:any) => (
        <List empty={false} {...props} hasEdit={true} hasList={true} 
          ...
          bulkActionButtons={< ListBulkActions />} filters={<NewsFilter />}
        >
          <Datagrid expand={<NewsShow />} >
...
<RichTextInput component="pre" multiline="true" source="subtitle">
