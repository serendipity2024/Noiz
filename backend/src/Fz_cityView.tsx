...
<TextInput source="name">
        ...
        <NumberInput source="province_id_≤">
      ...
      export const Fz_cityList = (props:any) => (
        <List empty={false} {...props} hasEdit={true} hasList={true} 
          ...
          bulkActionButtons={< ListBulkActions />} filters={<Fz_cityFilter />}
        >
          <Datagrid expand={<Fz_cityShow />} >
...
<NumberField source="province_id">
      ...
      export const Fz_cityEdit = (props:any) => (
...
<NumberInput source="province_id">
      ...
      export const Fz_cityCreate = (props:any) => (
        <Create {...props}>
          <SimpleForm>
            <NumberInput source="id" disabled={true}>
...
<NumberInput source="province_id">
      ...
      export const Fz_cityShow = (props:any) => (
        <Show {...props}>
          <SimpleShowLayout>
